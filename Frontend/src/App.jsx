...
function App() {
  ...
  const addChild = (data)=>{
    ...
    newElement.classList.add('rounded-lg','p-2', 'm-2')
    {data.user=='user'? 
      newElement.classList.add('bg-purple-300', 'text-white', 'self-end')
      :
      newElement.classList.add('bg-white', 'self-start')
    }
    newElement.textContent = data.message;
    chatContainer.current.appendChild(newElement)
  }
